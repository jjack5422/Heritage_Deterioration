...
DEFAULT_DATASET = PROJECT_ROOT.parents[1] / "datasets" / "dataset_clean_v2_merged_craquelure"
...
def _git_revision() -> str:
    result = subprocess.run(["git", "rev-parse", "HEAD"], cwd=PROJECT_ROOT.parents[1], capture_output=True, text=True, check=False)
