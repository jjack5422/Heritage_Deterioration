...
from crackseg_common.binary_reporting import binary_metric_row
...
_SKILL_REPORT_BUILDER = Path.home() / ".codex" / "skills" / "training-output-reporting" / "scripts" / "build_training_report.py"
_LOCAL_REPORT_BUILDER = Path(__file__).resolve().parents[2] / "scripts" / "reporting" / "training_output_reporting" / "build_training_report.py"
REPORT_BUILDER = _SKILL_REPORT_BUILDER if _SKILL_REPORT_BUILDER.is_file() else _LOCAL_REPORT_BUILDER
OUTER_COLUMNS = (
    "fold",
    "stage",
    "image",
