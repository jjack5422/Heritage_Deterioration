...
import model_projects.unet.src.train as train  # noqa: E402
from model_projects.unet.reporting.backfill import reconstructed_training_command  # noqa: E402
...
def test_backfill_reconstructs_the_unet_project_entrypoint() -> None:
    ...
    assert command[:2] == ["crackseg_env/bin/python", "model_projects/unet/src/train.py"]
