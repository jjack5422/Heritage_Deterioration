...
from model_projects.sam2_adapter.data import H0TileDataset, prepare_data_plan
...
pytestmark = pytest.mark.skipif(
    ...
    reason="external merged-craquelure dataset is not available",
)
...
def test_dataset_keeps_merged_mask_ids_and_normalizes_rgb() -> None:
    plan = prepare_data_plan(DATASET_ROOT, outer_fold=0)
