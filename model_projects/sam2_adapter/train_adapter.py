...
from model_projects.sam2_adapter.adapter_core import make_binary_target
from model_projects.sam2_adapter.adapter_model import SAM2AdapterMaskDecoder
from model_projects.sam2_adapter.data import H0DataPlan, denormalize_image, prepare_data_plan
from crackseg_common.losses import binary_bce_dice_loss
...
from crackseg_common.binary_reporting import (
    EpochReporter,
    RunLayout,
    append_log,
    finalize_reporting,
...
from model_projects.sam2_adapter.runtime import (
    DEFAULT_CHECKPOINT,
    DEFAULT_DATASET,
    _make_loader,
)
    ...
    *,
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            source = batch_tensor(batch, "mask", device).long()
