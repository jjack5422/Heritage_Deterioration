...
from crackseg_common.binary_reporting import _mask_rgb, _overlay_rgb, binary_metric_row
from crackseg_common.runtime import autocast_context, batch_tensor, seed_everything
from model_projects.sam3_adapter.training_data import denormalize_image, prepare_expert_data_plan
from model_projects.sam3_adapter.train import _build_model, _loader, parse_args
...
def export_one(experiment_id: str, expert: str) -> Path:
    manifest = REPOSITORY_ROOT / "outputs" / "deterioration_statistics" / "transfer_512" / f"{expert}.json"
    ...
    fold = PROJECT_ROOT / "runs" / experiment_id / "1fold" / expert / "fold0"
