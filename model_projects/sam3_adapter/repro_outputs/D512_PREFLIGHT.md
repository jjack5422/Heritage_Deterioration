...
```bash
/home/jacky/project/sam3_env/bin/python -m model_projects.sam3_adapter.train_probe \
...
目前 adapter 已移至獨立入口；等價 preflight 為：

```bash
PYTHONPATH=. /home/jacky/project/crackseg_env/bin/python -m model_projects.sam3_adapter.train \
  --expert scratch_crack --batch-size 4 --accumulation-steps 1 \
