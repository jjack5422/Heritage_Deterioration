...
Usage (from the repository root)::
    ...
    crackseg_env/bin/python -m model_projects.sam2_sac.train_h0
...
from model_projects.sam2_sac.data import H0DataPlan, H0TileDataset, denormalize_image, prepare_data_plan
...
from model_projects.sam2_sac.metrics import binary_summary
